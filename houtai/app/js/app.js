        ...
        function activate() {
          ...
          vm.login = function() {
            ...
            if(vm.loginForm.$valid) {
              ...
              $http
                .post('/manage/login/in', {user: vm.account.user, password: vm.account.password})
                .then(function(response) {
                    console.log(response);
                    if(response.code == 200){
                        $state.go('app.quanxianzu');
                    }else{
                        console.log("aaakkak")
                    }
                  if ( !response.account ) {
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper){
        ...
        $stateProvider
          .state('app', {
            ...
            //xin
            .state('app.permission_group', {
                url: '/permission_group',
                title: 'Permission Group',
                templateUrl: helper.basepath('permission_group.html'),
                resolve: helper.resolveFor('flot-chart','flot-chart-plugins', 'weather-icons')
            })
            .state('app.permission', {
                url: '/permission/:producerId',
                title: 'Permission',
                templateUrl: helper.basepath('permission.html'),
                resolve: helper.resolveFor('flot-chart','flot-chart-plugins', 'weather-icons')
            })
            .state('app.member_list', {
                url: '/member_list/:producerId',
                title: 'Member List',
                templateUrl: helper.basepath('member_list.html'),
                resolve: helper.resolveFor('flot-chart','flot-chart-plugins', 'weather-icons')
            })
            .state('app.add_sector', {
                url: '/add_sector',
                title: 'Add Sector',
                templateUrl: helper.basepath('add_sector.html'),
                resolve: helper.resolveFor('flot-chart','flot-chart-plugins', 'weather-icons')
            })
          //xin
          .state('app.dashboard', {
